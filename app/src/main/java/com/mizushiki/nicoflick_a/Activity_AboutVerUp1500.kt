...
import kotlinx.android.synthetic.main.activity_about_verup_1500.*

class Activity_AboutVerUp1500 : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_about_verup_1500)

        /// フラグメントのリストを作成
        val fragmentList = arrayListOf<Fragment>(
            Fragment_HowToGame.newInstance(R.drawable.chagnefavospec_v1500),
