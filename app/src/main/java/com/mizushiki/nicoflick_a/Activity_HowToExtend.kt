...
class Activity_HowToExtend : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_how_to_extend)

        /// フラグメントのリストを作成
        val fragmentList = arrayListOf<Fragment>(
            Fragment_HowToGame.newInstance(R.drawable.howto_extend1a),
            Fragment_HowToGame.newInstance(R.drawable.howto_extend2a),
            Fragment_HowToGame.newInstance(R.drawable.howto_extend3a),
